        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'To enable, tap "Continue" then select Location → "Allow all the time" in your device settings.',
                  ...
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Center(
                          child: Text('Continue', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w700)),
                        ),
                      ),
                    ),
                  ),
